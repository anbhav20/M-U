...
import { ConnectionStatusType } from '@shared/schema';

interface VideoOverlayProps {
  status: ConnectionStatusType;
}

export function VideoOverlay({ status }: VideoOverlayProps) {
  const getMessage = () => {
    switch (status) {
      case 'waiting':
...
export function VideoContainer({ localStreamRef, remoteStreamRef, isCameraOn }: VideoContainerProps) {
  return (
